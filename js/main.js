...
class HardestGame {
  constructor(context) {
    ...
    this.horizontaleBall = new HorizontaleBall(context, 20, 100, 15, 15, this.deathCounter);
    this.horizontaleBall1 = new HorizontaleBall(context, 780, 140, 15, 15, this.deathCounter);
    this.horizontaleBall2 = new HorizontaleBall(context, 20, 180, 15, 15, this.deathCounter);
    this.horizontaleBall3 = new HorizontaleBall(context, 780, 220, 15, 15, this.deathCounter);
    this.horizontaleBall4 = new HorizontaleBall(context, 20, 260, 15, 15, this.deathCounter);
    this.horizontaleBall5 = new HorizontaleBall(context, 780, 300, 15, 15, this.deathCounter);
    ...
    this.cross = new Cross(context, 200, 200, 185, 0.0359, this.deathCounter)
    this.cross1 = new Cross(context, 600, 200, 185, 0.0359, this.deathCounter)
    this.cross2 = new Cross(context, 400, 200, 200, 0.0359, this.deathCounter)
    this.verticalBall = new VerticalBall(context, 180, 300, 15, 15, this.deathCounter);
    this.verticalBall1 = new VerticalBall(context, 620, 300, 15, 15, this.deathCounter);
    this.verticalBall2 = new VerticalBall(context, 120, 300, 10, 15, this.deathCounter);
    this.verticalBall3 = new VerticalBall(context, 200, 300, 10, 15, this.deathCounter);
    this.verticalBall4 = new VerticalBall(context, 280, 300, 10, 15, this.deathCounter);
    this.verticalBall5 = new VerticalBall(context, 360, 300, 10, 15, this.deathCounter);
    this.verticalBall6 = new VerticalBall(context, 440, 300, 10, 15, this.deathCounter);
    this.verticalBall7 = new VerticalBall(context, 520, 300, 10, 15, this.deathCounter);
